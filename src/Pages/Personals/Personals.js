        ...
        <div className="all-posts">
            ...
            <div className="section">
              <div className="inner">
                ...
                কলেজ ভর্তির পালা আসলো, কোথায় ভর্তি হবো তা নিয়ে এক একজন একেক রকম পরামর্শ দিলো। অনেকেই বললো নিজ জেলায় ভর্তি হতে। 
                </p>
              </div>
              <div className="inner">
            ...
            <div className="section">
              <p className="details post-details">কিন্তু আমার মা এই ব্যাপারে অনড় যে, আমাকে লক্ষ্মীপুর ভর্তি করবেন না, ঢাকায় পাঠিয়ে দিবেন। এখানে থাকলে ভালো কোন প্রতিযোগী পাবো না, ভর্তি পরীক্ষায় পিছিয়ে যাবো। যাই হোক, আব্বুর এর বন্ধু, বাহার আঙ্কেল আম্মু কে বললেন, পিলখানায় কোন এক কলেজে উনি আমাকে ভর্তি করিয়ে দিবেন, আর ওনার বাসা জিগাতলায় থাকবো আমি। আমার মা অন্যদের সাথে পরামর্শ করে রাজি হলেন। {" "}
              </p>
              <br />
